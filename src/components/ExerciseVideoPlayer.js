...
const HER_VIDEOS = {
  ...
  situp: "/videos/deadbug.mp4",
  birddog: "/videos/donkey.mp4",
  twist: "/videos/deadbug.mp4",
  ...
  frogpump: "/videos/glutebridge.mp4",
  bulg: "/videos/glutebridge.mp4",
  squat: "/videos/glutebridge.mp4",
  calf: "/videos/glutebridge.mp4",
  ...
  shouldertap: "/videos/pushup.mp4",
  pikepush: "/videos/pikepush.mp4",
  doorwayrow: "/videos/tricepdip.mp4",
  mountainclimber: "/videos/pushup.mp4",
  flye: "/videos/chestprayer.mp4",
  cobra: "/videos/cobra.mp4",
  plank: "/videos/plank.mp4",
  wallslide: "/videos/cobra.mp4",
  superman: "/videos/cobra.mp4",
  downdog: "/videos/cobra.mp4",
