...
const EXERCISE_MEDIA = {
  ...
  frogpump: { img: "/reference/glutebridge.jpg", video: "/videos/glutebridge.mp4" },
  bulg: { img: "/banners/foundation.jpg", video: "/videos/glutebridge.mp4" },
  squat: { img: "/banners/foundation.jpg", video: "/videos/glutebridge.mp4" },
  calf: { img: "/banners/foundation.jpg", video: "/videos/glutebridge.mp4" },
  ...
  shouldertap: { img: "/reference/pushup.jpg", video: "/videos/pushup.mp4" },
  pikepush: { img: "/reference/pikepush.jpg", video: "/videos/pikepush.mp4" },
  doorwayrow: { img: "/reference/tricepdip.jpg", video: "/videos/tricepdip.mp4" },
  mountainclimber: { img: "/reference/pushup.jpg", video: "/videos/pushup.mp4" },
  flye: { img: "/reference/chestprayer.jpg", video: "/videos/chestprayer.mp4" },
  cobra: { img: "/reference/cobra.jpg", video: "/videos/cobra.mp4" },
  wallslide: { img: "/reference/cobra.jpg", video: "/videos/cobra.mp4" },
  superman: { img: "/reference/cobra.jpg", video: "/videos/cobra.mp4" },
  dog: { img: "/reference/cobra.jpg", video: "/videos/cobra.mp4" },
