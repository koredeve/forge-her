...
const EXERCISE_MEDIA = {
  ...
  inclinepush: { img: "/reference/inclinepush.jpg", video: "/videos/inclinepush.mp4" },
  pushup: { img: "/reference/pushup.jpg", video: "/videos/pushup.mp4" },
  kneepush: { img: "/reference/kneepush.jpg", video: "/videos/kneepush.mp4" },
  ...
  doorwayrow: { img: "/reference/doorwayrow.jpg", video: "/videos/doorwayrow.mp4" },
  mountainclimber: { img: "/reference/pushup.jpg", video: "/videos/pushup.mp4" },
  flye: { img: "/reference/flye.jpg", video: "/videos/flye.mp4" },
  cobra: { img: "/reference/cobra.jpg", video: "/videos/cobra.mp4" },
  wallslide: { img: "/reference/wallslide.jpg", video: "/videos/wallslide.mp4" },
  superman: { img: "/reference/superman.jpg", video: "/videos/superman.mp4" },
  dog: { img: "/reference/dog.jpg", video: "/videos/dog.mp4" },
